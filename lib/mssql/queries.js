...
FROM INFORMATION_SCHEMA.TABLES tab
WHERE TABLE_SCHEMA = ${schema}
AND tab.TABLE_NAME LIKE 'jhi!_%' ESCAPE '!';`;
...
// WHERE ke.CONSTRAINT_SCHEMA = ${schema}
...
FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE ke
LEFT JOIN INFORMATION_SCHEMA.COLUMNS col ON col.TABLE_NAME = ke.TABLE_NAME AND col.COLUMN_NAME = ke.COLUMN_NAME AND col.TABLE_SCHEMA = ke.TABLE_SCHEMA
WHERE ke.CONSTRAINT_SCHEMA = 'nopenope';`
};
...
AND tab.TABLE_NAME NOT LIKE 'spt!_%' ESCAPE '!'
AND tab.TABLE_NAME NOT IN ('MSreplication_options')
${queryFilter};`;
};
